...
public class GestionAlumnoDAO {
	...
	public int actualizar(Alumno a) {
		...
		try {
			con = MySQLConexion8.getConexion();
			String sql = "update james_school.alumno set nombreAlumno = ?, apellidoAlumno = ?, dniAlumno = ?, edadAlumno = ?, celularAlumno = ?, estadoAlumno = ? where codAlumno = ?;";
			pstm = con.prepareStatement(sql);
			...
			pstm.setInt(5, a.getCelular());
			pstm.setInt(6, a.getEstado());
			pstm.setString(7, a.getCodAlumno());
	...
	public ArrayList<Alumno> listar() {
		...
		try {
			...
			pstm = con.prepareStatement(sql);
			 ...
			 while(res.next()) {
				a = new Alumno();
				a.setCodAlumno(res.getString(1));
				a.setNombres(res.getString(2));
				a.setApellidos(res.getString(3));
				a.setDni(res.getString(4));
				a.setEdad(res.getInt(5));
				a.setCelular(res.getInt(6));
				a.setEstado(res.getInt(7));
